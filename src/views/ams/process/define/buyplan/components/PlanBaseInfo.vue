<template>
  <div class="app-container reim-base-ifno">
    <el-form :model="value" :rules="rules" ref="planInfoForm" label-width="120px" class="form-inner-container" size="small">
      ...
      <el-form-item style="text-align: center">
        <el-button type="primary" size="medium" @click="handleNext('planInfoForm')">下一步，填写采购明细</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
